  ...
  experiences: [
    {
      ...
      duties: [
        ...
        "Elaboração de materiais e estratégia de divulgação e publicação em redes sociais."
      ],
      company: "Nossa Casa"
    },
    {
    ...
    },
    {
      ...
      duties: [
        "Estagiário Internacional na cidade de Puebla, México, na área de marketing.",
  ...
  infos: [
    {
      ...
      about:
        'Aprender, evoluir e explorar limites são os motores de todas as experiências que escolho. Buscar novos conhecimentos é o objetivo em todas as atividades que realizo. Meus interesses são uma mistura de muitas áreas. Vão desde a sociedade, a economia e a inovação até o marketing e a programação. Acredito que a inovação depende do fluxo constante entre diferentes campos. Como dizia Lavoisier: "na natureza nada se cria e nada se perde, tudo se transforma".'
    }
  ],
  common: {
    loading: "Carregando...",
